                ...
                case 1:
                    ...
                    if (name_complet){
                        ...
                        if(search_save(name,fichier)){
                            ...
                            verif=fscanf(fichier,"%d %d %d %d %d %d %d %s %d %d %d %s %d %d ",&player.coordinates.x, &player.coordinates.y, &player.life, &player.level, &player.XP, &player.score, &player.strength, player.stuff.name, &player.stuff.id, &player.stuff.weight, &player.stuff.shield, player.blade.name, &player.blade.id, &temp);
                            if(verif==EOF){
                                printf("error load charging");
                                exit(3);
                                }                            
                            ...
                            for(int i=0;i<roomcount;i++){
                                ...
                                for(int j=0;j<tabroom[i].nbr_enemy;j++){
                                    ...
                                    verif=fscanf(fichier,"%d %d %d %d %d %d %d %d ",&tabroom[i].tab_enemy[j].coordinates.x, &tabroom[i].tab_enemy[j].coordinates.y, &tabroom[i].tab_enemy[j].life, &tabroom[i].tab_enemy[j].armor, &tabroom[i].tab_enemy[j].strength, &tabroom[i].tab_enemy[j].speed, &tabroom[i].tab_enemy[j].range, &temp);
                                    if(verif==EOF){
                                        printf("error load charging");
                                        exit(3);
                                        }
...
//completter save enemy
                                ...
                                for(int j=0;j<tabroom[i].nbr_object;j++){
                                    verif=fscanf(fichier,"%d %d ",&tabroom[i].tab_object[j].id, &tabroom[i].tab_object[j].stack);
                                    if(verif==EOF){
                                        printf("error load charging");
                                        exit(3);
                                        }
                        ...
                        for(int i=0;i<doorcount;i++){
                            if(tabdoor[i].x==player.coordinates.x && tabdoor[i].y-1==player.coordinates.y){
                                ...
                                if(tabdoor[i].roomnum2==-1){
                                    ...
                                    enemySpawn(tabroom[roomcount-1].nbr_enemy, &tabroom[roomcount-1]);
                                    stuffSpawn(&tabroom[roomcount-1], fichier_object, fichier_blade, fichier_stuff);
                                    }
                        ...
                        for(int i=0;i<doorcount;i++){
                            if(tabdoor[i].y==player.coordinates.y && tabdoor[i].x-1==player.coordinates.x){
                                ...
                                if(tabdoor[i].roomnum2==-1){
                                    ...
                                    tabroom[roomcount-1].nbr_blade=rand()%1;
/*
                                    printf("%d %d %d",tabroom[roomcount-1].nbr_enemy, tabroom[roomcount-1].xmin,tabroom[roomcount-1].ymin);
                                    exit(12);
*/
                                    enemySpawn(tabroom[roomcount-1].nbr_enemy, &tabroom[roomcount-1]);
                                    stuffSpawn(&tabroom[roomcount-1], fichier_object, fichier_blade, fichier_stuff);
...
/*
                ...
                if (test1==key_exit){
                    ...
                    verif2=fprintf(fichier,"%d %d %d %d %d %d %d %s %d %d %d %s %d ", player.coordinates.x, player.coordinates.y, player.life, player.level, player.XP, player.score, player.strength, player.stuff.name, player.stuff.id, player.stuff.weight, player.stuff.shield, player.blade.name, player.blade.id);
                    if(verif2==EOF){
                        printf("error load charging");
                        exit(5);
                        }   
                    ...
                    for(int i=0;i<roomcount;i++){
                        ...
                        for(int j=0;j<tabroom[i].nbr_enemy;j++){
                            ...
                            verif2=fprintf(fichier,"%d %d %d %d %d %d %d ",tabroom[i].tab_enemy[j].coordinates.x, tabroom[i].tab_enemy[j].coordinates.y, tabroom[i].tab_enemy[j].life, tabroom[i].tab_enemy[j].armor, tabroom[i].tab_enemy[j].strength, tabroom[i].tab_enemy[j].speed, tabroom[i].tab_enemy[j].range);
                            if(verif2==EOF){
                                printf("error load charging");
                                exit(3);
                                }
                        ...
                        //save object
                        for(int j=0;j<tabroom[i].nbr_object;j++){
                            verif2=fprintf(fichier,"%d %d ",tabroom[i].tab_object[j].id, tabroom[i].tab_object[j].stack);
                            if(verif2==EOF){
                                printf("error load charging");
                                exit(3);
                                }
